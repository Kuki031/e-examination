...
<div class="user-auth-main">
    <div class="user-auth-wrap">
        <form action="{{ route('auth.register') }}" method="POST">
            @csrf
            <input type="hidden" name="pin" value="JMBAG">
            ...
            <div class="user-auth-form-div">
                <label for="pin_value">Unesite JMBAG: </label>
            ...
            <div class="user-auth-form-div">
                <div class="user-auth-radio-selection">
                    ...
                    <div>
                        <div>
                            <input type="radio" name="status" value="r" {{ old('status') === 'r' ? 'checked' : '' }}> Redoviti
                        </div>
                        <div>
                            <input type="radio" name="status" value="i" {{ old('status') === 'i' ? 'checked' : '' }}> Izvanredni
                        </div>
                    </div>
                </div>
            </div>
